...
def train(x_train, y_train, vocab_processor, x_dev, y_dev,
    ...
    # 损失指数
    losses = tf.nn.softmax_cross_entropy_with_logits(logits=pred, labels=y_input) # 多分类结果
    ...
    # 评估
    predictions = tf.argmax(pred, 1, name="predictions")   # 测试
